...
import vivacurrency.io.vivawallet.fragments.ToSFragment;
...
public class AppIntroActivity extends AppIntro2 {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance(getString(R.string.app_intro_title), getString(R.string.app_intro_text), R.drawable.ether_intro, Color.parseColor("#000000")));
